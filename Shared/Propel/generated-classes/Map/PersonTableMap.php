...
class PersonTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('person_id', 'PersonId', 'VARCHAR', true, 36, null);
        ...
        $this->addForeignKey('type_id', 'TypeId', 'VARCHAR', 'type', 'type_id', true, 36, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':type_id',
        ...
        $this->addRelation('Business customer', '\\Business customer', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':person_id',
    1 => ':person_id',
  ),
), null, null, 'Business customers', false);
