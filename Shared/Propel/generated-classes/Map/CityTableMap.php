...
class CityTableMap extends TableMap
{
     ...
     */
    const COL_ZIP_CODE = 'city.zip_code';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('ZipCode', 'Name', ),
        self::TYPE_CAMELNAME     => array('zipCode', 'name', ),
        self::TYPE_COLNAME       => array(CityTableMap::COL_ZIP_CODE, CityTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('zip_code', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('ZipCode' => 0, 'Name' => 1, ),
        self::TYPE_CAMELNAME     => array('zipCode' => 0, 'name' => 1, ),
        self::TYPE_COLNAME       => array(CityTableMap::COL_ZIP_CODE => 0, CityTableMap::COL_NAME => 1, ),
        self::TYPE_FIELDNAME     => array('zip_code' => 0, 'name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('zip_code', 'ZipCode', 'INTEGER', true, null, null);
    ...
    {
        $this->addRelation('Person', '\\Person', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':zip_code',
    1 => ':zip_code',
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('ZipCode', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('ZipCode', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('ZipCode', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('ZipCode', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('ZipCode', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('ZipCode', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        return (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('ZipCode', TableMap::TYPE_PHPNAME, $indexType)
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CityTableMap::COL_ZIP_CODE);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CityTableMap::COL_ZIP_CODE, (array) $values, Criteria::IN);
        }
