...
class TypeTableMap extends TableMap
{
     ...
     */
    const COL_TYPE_ID = 'type.type_id';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'type.description';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('TypeId', 'Description', ),
        self::TYPE_CAMELNAME     => array('typeId', 'description', ),
        self::TYPE_COLNAME       => array(TypeTableMap::COL_TYPE_ID, TypeTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('type_id', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('TypeId' => 0, 'Description' => 1, ),
        self::TYPE_CAMELNAME     => array('typeId' => 0, 'description' => 1, ),
        self::TYPE_COLNAME       => array(TypeTableMap::COL_TYPE_ID => 0, TypeTableMap::COL_DESCRIPTION => 1, ),
        self::TYPE_FIELDNAME     => array('type_id' => 0, 'description' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('type_id', 'TypeId', 'VARCHAR', true, 36, null);
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(TypeTableMap::COL_TYPE_ID);
            $criteria->addSelectColumn(TypeTableMap::COL_DESCRIPTION);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(TypeTableMap::COL_TYPE_ID, (array) $values, Criteria::IN);
        }
