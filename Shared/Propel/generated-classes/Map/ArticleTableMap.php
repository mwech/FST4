...
class ArticleTableMap extends TableMap
{
     ...
     */
    const COL_ARTICLE_TYPE_ID = 'article.article_type_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('ArticleId', 'Description', 'Price', 'Creation', 'Visible', 'ShapeId', 'ArticleTypeId', ),
        self::TYPE_CAMELNAME     => array('articleId', 'description', 'price', 'creation', 'visible', 'shapeId', 'articleTypeId', ),
        self::TYPE_COLNAME       => array(ArticleTableMap::COL_ARTICLE_ID, ArticleTableMap::COL_DESCRIPTION, ArticleTableMap::COL_PRICE, ArticleTableMap::COL_CREATION, ArticleTableMap::COL_VISIBLE, ArticleTableMap::COL_SHAPE_ID, ArticleTableMap::COL_ARTICLE_TYPE_ID, ),
        self::TYPE_FIELDNAME     => array('article_id', 'description', 'price', 'creation', 'visible', 'shape_id', 'article_type_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('ArticleId' => 0, 'Description' => 1, 'Price' => 2, 'Creation' => 3, 'Visible' => 4, 'ShapeId' => 5, 'ArticleTypeId' => 6, ),
        self::TYPE_CAMELNAME     => array('articleId' => 0, 'description' => 1, 'price' => 2, 'creation' => 3, 'visible' => 4, 'shapeId' => 5, 'articleTypeId' => 6, ),
        self::TYPE_COLNAME       => array(ArticleTableMap::COL_ARTICLE_ID => 0, ArticleTableMap::COL_DESCRIPTION => 1, ArticleTableMap::COL_PRICE => 2, ArticleTableMap::COL_CREATION => 3, ArticleTableMap::COL_VISIBLE => 4, ArticleTableMap::COL_SHAPE_ID => 5, ArticleTableMap::COL_ARTICLE_TYPE_ID => 6, ),
        self::TYPE_FIELDNAME     => array('article_id' => 0, 'description' => 1, 'price' => 2, 'creation' => 3, 'visible' => 4, 'shape_id' => 5, 'article_type_id' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('article_id', 'ArticleId', 'VARCHAR', true, 36, null);
        ...
        $this->addForeignKey('shape_id', 'ShapeId', 'VARCHAR', 'shape', 'shape_id', true, 36, null);
        $this->addForeignKey('article_type_id', 'ArticleTypeId', 'VARCHAR', 'article_type', 'article_type_id', true, 36, null);
    } // initialize()
    ...
    {
        $this->addRelation('ArticleType', '\\ArticleType', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':article_type_id',
    1 => ':article_type_id',
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ArticleTableMap::COL_ARTICLE_TYPE_ID);
        } else {
