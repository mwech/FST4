 ...
 *
 * @method     ChildPackageHasArticles findOneByPackageId(string $package_id) Return the first ChildPackageHasArticles filtered by the package_id column
 * @method     ChildPackageHasArticles findOneByArticleId(string $article_id) Return the first ChildPackageHasArticles filtered by the article_id column *
 ...
 *
 * @method     ChildPackageHasArticles requireOneByPackageId(string $package_id) Return the first ChildPackageHasArticles filtered by the package_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPackageHasArticles requireOneByArticleId(string $article_id) Return the first ChildPackageHasArticles filtered by the article_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPackageHasArticles[]|ObjectCollection findByPackageId(string $package_id) Return ChildPackageHasArticles objects filtered by the package_id column
 * @method     ChildPackageHasArticles[]|ObjectCollection findByArticleId(string $article_id) Return ChildPackageHasArticles objects filtered by the article_id column
...
abstract class PackageHasArticlesQuery extends ModelCriteria
{
     ...
     * Example usage:
     * <code>
     * $query->filterByPackageId('fooValue');   // WHERE package_id = 'fooValue'
     * $query->filterByPackageId('%fooValue%', Criteria::LIKE); // WHERE package_id LIKE '%fooValue%'
     * </code>
     *
