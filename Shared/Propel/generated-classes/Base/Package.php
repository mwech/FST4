...
abstract class Package implements ActiveRecordInterface
{
    ...
    public function setPackageId($v)
    {
        ...
        if ($this->package_id !== $v) {
            $this->package_id = $v;
            $this->modifiedColumns[PackageTableMap::COL_PACKAGE_ID] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[PackageTableMap::COL_PRICE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PackageTableMap::translateFieldName('PackageId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->package_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PackageTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PackageTableMap::COL_PACKAGE_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PackageTableMap::COL_PACKAGE_ID)) {
            $criteria->add(PackageTableMap::COL_PACKAGE_ID, $this->package_id);
        }
        if ($this->isColumnModified(PackageTableMap::COL_DESCRIPTION)) {
    ...
    public function setPackageHasArticless(Collection $packageHasArticless, ConnectionInterface $con = null)
    {
        ...
        foreach ($packageHasArticlessToDelete as $packageHasArticlesRemoved) {
            $packageHasArticlesRemoved->setPackage(null);
        }
    ...
    protected function doAddPackageHasArticles(ChildPackageHasArticles $packageHasArticles)
    {
        ...
        $packageHasArticles->setPackage($this);
    }
    ...
    public function removePackageHasArticles(ChildPackageHasArticles $packageHasArticles)
    {
        if ($this->getPackageHasArticless()->contains($packageHasArticles)) {
            ...
            $packageHasArticles->setPackage(null);
        }
     ...
     * @return ObjectCollection|ChildPackageHasArticles[] List of ChildPackageHasArticles objects
     */
    public function getPackageHasArticlessJoinArticle(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPackageHasArticlesQuery::create(null, $criteria);
