...
abstract class Article implements ActiveRecordInterface
{
    ...
    /**
     * @var        ChildArticleType
     */
    protected $aArticleType;
    ...
    public function setArticleTypeId($v)
    {
        ...
        if ($this->article_type_id !== $v) {
            ...
            $this->modifiedColumns[ArticleTableMap::COL_ARTICLE_TYPE_ID] = true;
        }

        if ($this->aArticleType !== null && $this->aArticleType->getArticleTypeId() !== $v) {
            $this->aArticleType = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ArticleTableMap::translateFieldName('ArticleTypeId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aArticleType !== null && $this->article_type_id !== $this->aArticleType->getArticleTypeId()) {
            $this->aArticleType = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aArticleType !== null) {
                if ($this->aArticleType->isModified() || $this->aArticleType->isNew()) {
                    $affectedRows += $this->aArticleType->save($con);
                }
                $this->setArticleType($this->aArticleType);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ArticleTableMap::COL_ARTICLE_TYPE_ID)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aArticleType) {
                ...
                $result[$key] = $this->aArticleType->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aShape) {
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setArticleTypeId($arr[$keys[6]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArticleTableMap::COL_ARTICLE_TYPE_ID)) {
            $criteria->add(ArticleTableMap::COL_ARTICLE_TYPE_ID, $this->article_type_id);
        }
    ...
    /**
     * Declares an association between this object and a ChildArticleType object.
     *
     * @param  ChildArticleType $v
     * @return $this|\Article The current object (for fluent API support)
     * @throws PropelException
     */
    public function setArticleType(ChildArticleType $v = null)
    {
        if ($v === null) {
            $this->setArticleTypeId(NULL);
        } else {
            $this->setArticleTypeId($v->getArticleTypeId());
        }

        $this->aArticleType = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildArticleType object, it will not be re-added.
        if ($v !== null) {
            $v->addArticle($this);
        }
    ...
    /**
     * Get the associated ChildArticleType object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildArticleType The associated ChildArticleType object.
     * @throws PropelException
     */
    public function getArticleType(ConnectionInterface $con = null)
    {
        if ($this->aArticleType === null && (($this->article_type_id !== "" && $this->article_type_id !== null))) {
            $this->aArticleType = ChildArticleTypeQuery::create()->findPk($this->article_type_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aArticleType->addArticles($this);
             */
        }

        return $this->aArticleType;
    }
    ...
    {
        if ($this->aShape === null && (($this->shape_id !== "" && $this->shape_id !== null))) {
    ...
    {
        if (null !== $this->aArticleType) {
            $this->aArticleType->removeArticle($this);
        }
        if (null !== $this->aShape) {
