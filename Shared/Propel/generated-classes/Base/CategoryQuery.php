 ...
 *
 * @method     ChildCategoryQuery leftJoinIngredientHasCategory($relationAlias = null) Adds a LEFT JOIN clause to the query using the IngredientHasCategory relation
 * @method     ChildCategoryQuery rightJoinIngredientHasCategory($relationAlias = null) Adds a RIGHT JOIN clause to the query using the IngredientHasCategory relation
 * @method     ChildCategoryQuery innerJoinIngredientHasCategory($relationAlias = null) Adds a INNER JOIN clause to the query using the IngredientHasCategory relation
 *
 * @method     ChildCategoryQuery joinWithIngredientHasCategory($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the IngredientHasCategory relation
 *
 * @method     ChildCategoryQuery leftJoinWithIngredientHasCategory() Adds a LEFT JOIN clause and with to the query using the IngredientHasCategory relation
 * @method     ChildCategoryQuery rightJoinWithIngredientHasCategory() Adds a RIGHT JOIN clause and with to the query using the IngredientHasCategory relation
 * @method     ChildCategoryQuery innerJoinWithIngredientHasCategory() Adds a INNER JOIN clause and with to the query using the IngredientHasCategory relation
 *
 * @method     \IngredientHasCategoryQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CategoryQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'FST4', $modelName = '\\Category', $modelAlias = null)
    {
    ...
    public function filterByIngredientHasCategory($ingredientHasCategory, $comparison = null)
    {
        if ($ingredientHasCategory instanceof \IngredientHasCategory) {
            return $this
                ->addUsingAlias(CategoryTableMap::COL_CATEGORY_ID, $ingredientHasCategory->getCategoryId(), $comparison);
