...
/**
 * Base class that represents a row from the 'article_type' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class ArticleType implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ArticleTypeTableMap';
    ...
    /**
     * The value for the article_type_id field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Base\ArticleType object.
     */
    ...
    /**
     * Compares this with another <code>ArticleType</code> instance.  If
     * <code>obj</code> is an instance of <code>ArticleType</code>, delegates to
     * <code>equals(ArticleType)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ArticleType The current object, for fluid interface
     */
    ...
    /**
     * Get the [article_type_id] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [article_type_id] column.
     *
     * @param string $v new value
     * @return $this|\ArticleType The current object (for fluent API support)
     */
    public function setArticleTypeId($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->article_type_id !== $v) {
            $this->article_type_id = $v;
            $this->modifiedColumns[ArticleTypeTableMap::COL_ARTICLE_TYPE_ID] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[ArticleTypeTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ArticleTypeTableMap::translateFieldName('ArticleTypeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->article_type_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ArticleTypeTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = ArticleTypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ArticleType'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildArticleTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ArticleType::setDeleted()
     * @see ArticleType::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildArticleTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ArticleTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ArticleTypeTableMap::COL_ARTICLE_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'article_type_id';
        }
        if ($this->isColumnModified(ArticleTypeTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }

        $sql = sprintf(
            'INSERT INTO article_type (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'article_type_id':
                        $stmt->bindValue($identifier, $this->article_type_id, PDO::PARAM_STR);
                        break;
                    case 'description':
    ...
    {
        $pos = ArticleTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ArticleType'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ArticleType'][$this->hashCode()] = true;
        $keys = ArticleTypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getArticleTypeId(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setArticleTypeId($arr[$keys[0]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArticleTypeTableMap::COL_ARTICLE_TYPE_ID)) {
            $criteria->add(ArticleTypeTableMap::COL_ARTICLE_TYPE_ID, $this->article_type_id);
        }
        if ($this->isColumnModified(ArticleTypeTableMap::COL_DESCRIPTION)) {
            $criteria->add(ArticleTypeTableMap::COL_DESCRIPTION, $this->description);
        }
    ...
    {
        $criteria = ChildArticleTypeQuery::create();
        $criteria->add(ArticleTypeTableMap::COL_ARTICLE_TYPE_ID, $this->article_type_id);
    ...
    {
        $validPk = null !== $this->getArticleTypeId();
    ...
    /**
     * Generic method to set the primary key (article_type_id column).
     *
    ...
    {
        return null === $this->getArticleTypeId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ArticleType (or compatible) type.
    ...
    {
        $copyObj->setArticleTypeId($this->getArticleTypeId());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ArticleType Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildArticleType is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildArticleType The current object (for fluent API support)
     */
    public function setArticles(Collection $articles, ConnectionInterface $con = null)
    {
        ...
        foreach ($articlesToDelete as $articleRemoved) {
            $articleRemoved->setArticleType(null);
        }
     ...
     * Otherwise if this ArticleType is new, it will return
     * an empty collection; or if this ArticleType has previously
     * been saved, it will retrieve related Articles from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ArticleType.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildArticle[] List of ChildArticle objects
     */
    public function getArticlesJoinShape(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildArticleQuery::create(null, $criteria);
        $query->joinWith('Shape', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(ArticleTypeTableMap::DEFAULT_STRING_FORMAT);
    }
