 ...
 *
 * @method     ChildVoucher findOneByVoucherId(string $voucher_id) Return the first ChildVoucher filtered by the voucher_id column
 ...
 * @method     ChildVoucher findOneByUsed(boolean $used) Return the first ChildVoucher filtered by the used column
 ...
 *
 * @method     ChildVoucher requireOneByVoucherId(string $voucher_id) Return the first ChildVoucher filtered by the voucher_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildVoucher requireOneByUsed(boolean $used) Return the first ChildVoucher filtered by the used column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildVoucher[]|ObjectCollection findByVoucherId(string $voucher_id) Return ChildVoucher objects filtered by the voucher_id column
 ...
 * @method     ChildVoucher[]|ObjectCollection findByUsed(boolean $used) Return ChildVoucher objects filtered by the used column
