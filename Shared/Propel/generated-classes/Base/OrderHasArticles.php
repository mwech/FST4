...
/**
 * Base class that represents a row from the 'order_has_articles' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class OrderHasArticles implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\OrderHasArticlesTableMap';
    ...
    /**
     * Initializes internal state of Base\OrderHasArticles object.
     */
    ...
    /**
     * Compares this with another <code>OrderHasArticles</code> instance.  If
     * <code>obj</code> is an instance of <code>OrderHasArticles</code>, delegates to
     * <code>equals(OrderHasArticles)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|OrderHasArticles The current object, for fluid interface
     */
    ...
    public function setOrderId($v)
    {
        ...
        if ($this->order_id !== $v) {
            $this->order_id = $v;
            $this->modifiedColumns[OrderHasArticlesTableMap::COL_ORDER_ID] = true;
        }
    ...
    public function setArticleId($v)
    {
        ...
        if ($this->article_id !== $v) {
            $this->article_id = $v;
            $this->modifiedColumns[OrderHasArticlesTableMap::COL_ARTICLE_ID] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[OrderHasArticlesTableMap::COL_AMOUNT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OrderHasArticlesTableMap::translateFieldName('OrderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OrderHasArticlesTableMap::translateFieldName('ArticleId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOrderHasArticlesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see OrderHasArticles::setDeleted()
     * @see OrderHasArticles::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOrderHasArticlesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OrderHasArticlesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OrderHasArticlesTableMap::COL_ORDER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'order_id';
        }
        if ($this->isColumnModified(OrderHasArticlesTableMap::COL_ARTICLE_ID)) {
    ...
    {
        $pos = OrderHasArticlesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['OrderHasArticles'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OrderHasArticles'][$this->hashCode()] = true;
        $keys = OrderHasArticlesTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrderHasArticlesTableMap::COL_ORDER_ID)) {
            $criteria->add(OrderHasArticlesTableMap::COL_ORDER_ID, $this->order_id);
        }
        if ($this->isColumnModified(OrderHasArticlesTableMap::COL_ARTICLE_ID)) {
            $criteria->add(OrderHasArticlesTableMap::COL_ARTICLE_ID, $this->article_id);
        }
        if ($this->isColumnModified(OrderHasArticlesTableMap::COL_AMOUNT)) {
    ...
    {
        $criteria = ChildOrderHasArticlesQuery::create();
        $criteria->add(OrderHasArticlesTableMap::COL_ORDER_ID, $this->order_id);
        $criteria->add(OrderHasArticlesTableMap::COL_ARTICLE_ID, $this->article_id);
    ...
    public function hashCode()
    {
        ...
        //relation fk_order_has_articles_article1 to table article
        ...
        //relation fk_order_has_articles_order1 to table order
    ...
    {
        return (null === $this->getOrderId()) && (null === $this->getArticleId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \OrderHasArticles (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \OrderHasArticles Clone of current object.
     * @throws PropelException
     */
    ...
    public function getArticle(ConnectionInterface $con = null)
    {
        if ($this->aArticle === null && (($this->article_id !== "" && $this->article_id !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aArticle->addOrderHasArticless($this);
             */
        }
    ...
    {
        if ($this->aOrder === null && (($this->order_id !== "" && $this->order_id !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOrder->addOrderHasArticless($this);
             */
        }
    ...
    {
        if (null !== $this->aArticle) {
            $this->aArticle->removeOrderHasArticles($this);
        }
        if (null !== $this->aOrder) {
            $this->aOrder->removeOrderHasArticles($this);
        }
        $this->order_id = null;
    ...
    {
        return (string) $this->exportTo(OrderHasArticlesTableMap::DEFAULT_STRING_FORMAT);
    }
