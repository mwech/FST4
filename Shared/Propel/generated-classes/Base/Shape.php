...
/**
 * Base class that represents a row from the 'shape' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Shape implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ShapeTableMap';
    ...
    /**
     * Initializes internal state of Base\Shape object.
     */
    ...
    /**
     * Compares this with another <code>Shape</code> instance.  If
     * <code>obj</code> is an instance of <code>Shape</code>, delegates to
     * <code>equals(Shape)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Shape The current object, for fluid interface
     */
     ...
     * @return $this|\Shape The current object (for fluent API support)
     */
    public function setShapeId($v)
    {
        ...
        if ($this->shape_id !== $v) {
            $this->shape_id = $v;
            $this->modifiedColumns[ShapeTableMap::COL_SHAPE_ID] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[ShapeTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ShapeTableMap::translateFieldName('ShapeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shape_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ShapeTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = ShapeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Shape'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildShapeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildShapeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ShapeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ShapeTableMap::COL_SHAPE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'shape_id';
        }
        if ($this->isColumnModified(ShapeTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }

        $sql = sprintf(
            'INSERT INTO shape (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'shape_id':
                        $stmt->bindValue($identifier, $this->shape_id, PDO::PARAM_STR);
                        break;
                    case 'description':
    ...
    {
        $pos = ShapeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Shape'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Shape'][$this->hashCode()] = true;
        $keys = ShapeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getShapeId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ShapeTableMap::COL_SHAPE_ID)) {
            $criteria->add(ShapeTableMap::COL_SHAPE_ID, $this->shape_id);
        }
        if ($this->isColumnModified(ShapeTableMap::COL_DESCRIPTION)) {
            $criteria->add(ShapeTableMap::COL_DESCRIPTION, $this->description);
        }
    ...
    {
        $criteria = ChildShapeQuery::create();
        $criteria->add(ShapeTableMap::COL_SHAPE_ID, $this->shape_id);
    ...
    /**
     * Generic method to set the primary key (shape_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Shape (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Shape Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildShape is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildShape The current object (for fluent API support)
     */
     ...
     * Otherwise if this Shape is new, it will return
     * an empty collection; or if this Shape has previously
     * been saved, it will retrieve related Articles from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Shape.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildArticle[] List of ChildArticle objects
     */
    public function getArticlesJoinArticleType(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildArticleQuery::create(null, $criteria);
        $query->joinWith('ArticleType', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(ShapeTableMap::DEFAULT_STRING_FORMAT);
    }
