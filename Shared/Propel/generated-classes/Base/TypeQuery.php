 ...
 *
 * @method     ChildType findOneByTypeId(string $type_id) Return the first ChildType filtered by the type_id column
 ...
 *
 * @method     ChildType requireOneByTypeId(string $type_id) Return the first ChildType filtered by the type_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildType[]|ObjectCollection findByTypeId(string $type_id) Return ChildType objects filtered by the type_id column
