...
/**
 * This class defines the structure of the 'voucher' table.
 *
 *
 *
...
class VoucherTableMap extends TableMap
{
     ...
     */
    const COL_VOUCHER_ID = 'voucher.voucher_id';

    /**
     * the column name for the amount field
     */
    const COL_AMOUNT = 'voucher.amount';

    /**
     * the column name for the code field
     */
    const COL_CODE = 'voucher.code';

    /**
     * the column name for the used field
     */
    const COL_USED = 'voucher.used';

    /**
     * the column name for the date field
     */
    const COL_DATE = 'voucher.date';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('VoucherId', 'Amount', 'Code', 'Used', 'Date', ),
        self::TYPE_CAMELNAME     => array('voucherId', 'amount', 'code', 'used', 'date', ),
        self::TYPE_COLNAME       => array(VoucherTableMap::COL_VOUCHER_ID, VoucherTableMap::COL_AMOUNT, VoucherTableMap::COL_CODE, VoucherTableMap::COL_USED, VoucherTableMap::COL_DATE, ),
        self::TYPE_FIELDNAME     => array('voucher_id', 'amount', 'code', 'used', 'date', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('VoucherId' => 0, 'Amount' => 1, 'Code' => 2, 'Used' => 3, 'Date' => 4, ),
        self::TYPE_CAMELNAME     => array('voucherId' => 0, 'amount' => 1, 'code' => 2, 'used' => 3, 'date' => 4, ),
        self::TYPE_COLNAME       => array(VoucherTableMap::COL_VOUCHER_ID => 0, VoucherTableMap::COL_AMOUNT => 1, VoucherTableMap::COL_CODE => 2, VoucherTableMap::COL_USED => 3, VoucherTableMap::COL_DATE => 4, ),
        self::TYPE_FIELDNAME     => array('voucher_id' => 0, 'amount' => 1, 'code' => 2, 'used' => 3, 'date' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('voucher_id', 'VoucherId', 'INTEGER', true, null, null);
        $this->addColumn('amount', 'Amount', 'DOUBLE', false, null, null);
        $this->addColumn('code', 'Code', 'VARCHAR', false, 10, null);
        $this->addColumn('used', 'Used', 'VARCHAR', false, 1, null);
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('VoucherId', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('VoucherId', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('VoucherId', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('VoucherId', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('VoucherId', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('VoucherId', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        return (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('VoucherId', TableMap::TYPE_PHPNAME, $indexType)
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(VoucherTableMap::COL_VOUCHER_ID);
            $criteria->addSelectColumn(VoucherTableMap::COL_AMOUNT);
            $criteria->addSelectColumn(VoucherTableMap::COL_CODE);
            $criteria->addSelectColumn(VoucherTableMap::COL_USED);
            $criteria->addSelectColumn(VoucherTableMap::COL_DATE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(VoucherTableMap::COL_VOUCHER_ID, (array) $values, Criteria::IN);
        }
