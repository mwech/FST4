 ...
 *
 * @method     ChildArticleHasIngredient findOneByArticleId(int $article_id) Return the first ChildArticleHasIngredient filtered by the article_id column
 * @method     ChildArticleHasIngredient findOneByIngredientId(int $ingredient_id) Return the first ChildArticleHasIngredient filtered by the ingredient_id column
 ...
 *
 * @method     ChildArticleHasIngredient requireOneByArticleId(int $article_id) Return the first ChildArticleHasIngredient filtered by the article_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildArticleHasIngredient requireOneByIngredientId(int $ingredient_id) Return the first ChildArticleHasIngredient filtered by the ingredient_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildArticleHasIngredient[]|ObjectCollection findByArticleId(int $article_id) Return ChildArticleHasIngredient objects filtered by the article_id column
 * @method     ChildArticleHasIngredient[]|ObjectCollection findByIngredientId(int $ingredient_id) Return ChildArticleHasIngredient objects filtered by the ingredient_id column
    ...
    public function filterByArticleId($articleId = null, $comparison = null)
    {
        if (is_array($articleId)) {
            ...
            if (isset($articleId['min'])) {
                $this->addUsingAlias(ArticleHasIngredientTableMap::COL_ARTICLE_ID, $articleId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($articleId['max'])) {
                $this->addUsingAlias(ArticleHasIngredientTableMap::COL_ARTICLE_ID, $articleId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByIngredientId($ingredientId = null, $comparison = null)
    {
        if (is_array($ingredientId)) {
            ...
            if (isset($ingredientId['min'])) {
                $this->addUsingAlias(ArticleHasIngredientTableMap::COL_INGREDIENT_ID, $ingredientId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($ingredientId['max'])) {
                $this->addUsingAlias(ArticleHasIngredientTableMap::COL_INGREDIENT_ID, $ingredientId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
