 ...
 * @method     ChildOrder findOneByPersonId(int $person_id) Return the first ChildOrder filtered by the person_id column
 * @method     ChildOrder findOneByVoucherId(int $voucher_id) Return the first ChildOrder filtered by the voucher_id column *
 ...
 * @method     ChildOrder requireOneByPersonId(int $person_id) Return the first ChildOrder filtered by the person_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildOrder requireOneByVoucherId(int $voucher_id) Return the first ChildOrder filtered by the voucher_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildOrder[]|ObjectCollection findByPersonId(int $person_id) Return ChildOrder objects filtered by the person_id column
 * @method     ChildOrder[]|ObjectCollection findByVoucherId(int $voucher_id) Return ChildOrder objects filtered by the voucher_id column
    ...
    public function filterByPersonId($personId = null, $comparison = null)
    {
        if (is_array($personId)) {
            ...
            if (isset($personId['min'])) {
                $this->addUsingAlias(OrderTableMap::COL_PERSON_ID, $personId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($personId['max'])) {
                $this->addUsingAlias(OrderTableMap::COL_PERSON_ID, $personId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByVoucherId($voucherId = null, $comparison = null)
    {
        if (is_array($voucherId)) {
            ...
            if (isset($voucherId['min'])) {
                $this->addUsingAlias(OrderTableMap::COL_VOUCHER_ID, $voucherId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($voucherId['max'])) {
                $this->addUsingAlias(OrderTableMap::COL_VOUCHER_ID, $voucherId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
