...
/**
 * Base class that represents a row from the 'cake_type' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class CakeType implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CakeTypeTableMap';
    ...
    /**
     * Initializes internal state of Base\CakeType object.
     */
    ...
    /**
     * Compares this with another <code>CakeType</code> instance.  If
     * <code>obj</code> is an instance of <code>CakeType</code>, delegates to
     * <code>equals(CakeType)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CakeType The current object, for fluid interface
     */
     ...
     * @return $this|\CakeType The current object (for fluent API support)
     */
    public function setCakeTypeId($v)
    {
        ...
        if ($this->cake_type_id !== $v) {
            $this->cake_type_id = $v;
            $this->modifiedColumns[CakeTypeTableMap::COL_CAKE_TYPE_ID] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[CakeTypeTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CakeTypeTableMap::translateFieldName('CakeTypeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cake_type_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CakeTypeTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = CakeTypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CakeType'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCakeTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CakeType::setDeleted()
     * @see CakeType::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCakeTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CakeTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CakeTypeTableMap::COL_CAKE_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'cake_type_id';
        }
        if ($this->isColumnModified(CakeTypeTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }

        $sql = sprintf(
            'INSERT INTO cake_type (%s) VALUES (%s)',
    ...
    {
        $pos = CakeTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CakeType'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CakeType'][$this->hashCode()] = true;
        $keys = CakeTypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCakeTypeId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CakeTypeTableMap::COL_CAKE_TYPE_ID)) {
            $criteria->add(CakeTypeTableMap::COL_CAKE_TYPE_ID, $this->cake_type_id);
        }
        if ($this->isColumnModified(CakeTypeTableMap::COL_DESCRIPTION)) {
            $criteria->add(CakeTypeTableMap::COL_DESCRIPTION, $this->description);
        }
    ...
    {
        $criteria = ChildCakeTypeQuery::create();
        $criteria->add(CakeTypeTableMap::COL_CAKE_TYPE_ID, $this->cake_type_id);
    ...
    {
        $validPk = null !== $this->getCakeTypeId();
    ...
    /**
     * Generic method to set the primary key (cake_type_id column).
     *
    ...
    {
        return null === $this->getCakeTypeId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CakeType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CakeType Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCakeType is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCakeType The current object (for fluent API support)
     */
    public function setArticles(Collection $articles, ConnectionInterface $con = null)
    {
        ...
        foreach ($articlesToDelete as $articleRemoved) {
            $articleRemoved->setCakeType(null);
        }
     ...
     * Otherwise if this CakeType is new, it will return
     * an empty collection; or if this CakeType has previously
     * been saved, it will retrieve related Articles from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CakeType.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(CakeTypeTableMap::DEFAULT_STRING_FORMAT);
    }
