...
abstract class Ingredient implements ActiveRecordInterface
{
    ...
    public function setIngredientHasAllergies(Collection $ingredientHasAllergies, ConnectionInterface $con = null)
    {
        ...
        foreach ($ingredientHasAllergiesToDelete as $ingredientHasAllergyRemoved) {
            $ingredientHasAllergyRemoved->setIngredient(null);
        }
    ...
    protected function doAddIngredientHasAllergy(ChildIngredientHasAllergy $ingredientHasAllergy)
    {
        ...
        $ingredientHasAllergy->setIngredient($this);
    }
    ...
    public function removeIngredientHasAllergy(ChildIngredientHasAllergy $ingredientHasAllergy)
    {
        if ($this->getIngredientHasAllergies()->contains($ingredientHasAllergy)) {
            ...
            $ingredientHasAllergy->setIngredient(null);
        }
     ...
     * @return ObjectCollection|ChildIngredientHasAllergy[] List of ChildIngredientHasAllergy objects
     */
    public function getIngredientHasAllergiesJoinAllergy(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildIngredientHasAllergyQuery::create(null, $criteria);
        $query->joinWith('Allergy', $joinBehavior);
