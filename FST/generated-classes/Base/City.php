...
abstract class City implements ActiveRecordInterface
{
    ...
    public function setZipCode($v)
    {
        ...
        if ($this->zip_code !== $v) {
            $this->zip_code = $v;
            $this->modifiedColumns[CityTableMap::COL_ZIP_CODE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CityTableMap::translateFieldName('ZipCode', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CityTableMap::COL_ZIP_CODE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CityTableMap::COL_ZIP_CODE)) {
            $criteria->add(CityTableMap::COL_ZIP_CODE, $this->zip_code);
        }
        if ($this->isColumnModified(CityTableMap::COL_NAME)) {
     ...
     * @return ObjectCollection|ChildPerson[] List of ChildPerson objects
     */
    public function getPeopleJoinType(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPersonQuery::create(null, $criteria);
