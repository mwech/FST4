 ...
 *
 * @method     ChildOrderHasArticles findOneByOrderId(int $order_id) Return the first ChildOrderHasArticles filtered by the order_id column
 * @method     ChildOrderHasArticles findOneByArticleId(int $article_id) Return the first ChildOrderHasArticles filtered by the article_id column
 ...
 *
 * @method     ChildOrderHasArticles requireOneByOrderId(int $order_id) Return the first ChildOrderHasArticles filtered by the order_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildOrderHasArticles requireOneByArticleId(int $article_id) Return the first ChildOrderHasArticles filtered by the article_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildOrderHasArticles[]|ObjectCollection findByOrderId(int $order_id) Return ChildOrderHasArticles objects filtered by the order_id column
 * @method     ChildOrderHasArticles[]|ObjectCollection findByArticleId(int $article_id) Return ChildOrderHasArticles objects filtered by the article_id column
    ...
    public function filterByOrderId($orderId = null, $comparison = null)
    {
        if (is_array($orderId)) {
            ...
            if (isset($orderId['min'])) {
                $this->addUsingAlias(OrderHasArticlesTableMap::COL_ORDER_ID, $orderId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($orderId['max'])) {
                $this->addUsingAlias(OrderHasArticlesTableMap::COL_ORDER_ID, $orderId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByArticleId($articleId = null, $comparison = null)
    {
        if (is_array($articleId)) {
            ...
            if (isset($articleId['min'])) {
                $this->addUsingAlias(OrderHasArticlesTableMap::COL_ARTICLE_ID, $articleId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($articleId['max'])) {
                $this->addUsingAlias(OrderHasArticlesTableMap::COL_ARTICLE_ID, $articleId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
