...
abstract class Type implements ActiveRecordInterface
{
    ...
    public function setTypeId($v)
    {
        ...
        if ($this->type_id !== $v) {
            $this->type_id = $v;
            $this->modifiedColumns[TypeTableMap::COL_TYPE_ID] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[TypeTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TypeTableMap::translateFieldName('TypeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TypeTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TypeTableMap::COL_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'type_id';
        }
        if ($this->isColumnModified(TypeTableMap::COL_DESCRIPTION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TypeTableMap::COL_TYPE_ID)) {
            $criteria->add(TypeTableMap::COL_TYPE_ID, $this->type_id);
        }
        if ($this->isColumnModified(TypeTableMap::COL_DESCRIPTION)) {
            $criteria->add(TypeTableMap::COL_DESCRIPTION, $this->description);
        }
     ...
     * @return ObjectCollection|ChildPerson[] List of ChildPerson objects
     */
    public function getPeopleJoinCity(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPersonQuery::create(null, $criteria);
