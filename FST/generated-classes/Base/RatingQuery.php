 ...
 *
 * @method     ChildRating findOneByArticleId(int $article_id) Return the first ChildRating filtered by the article_id column
 * @method     ChildRating findOneByPersonId(int $person_id) Return the first ChildRating filtered by the person_id column
 ...
 * @method     ChildRating findOneByVisible(string $visible) Return the first ChildRating filtered by the visible column *
 ...
 *
 * @method     ChildRating requireOneByArticleId(int $article_id) Return the first ChildRating filtered by the article_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildRating requireOneByPersonId(int $person_id) Return the first ChildRating filtered by the person_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildRating requireOneByVisible(string $visible) Return the first ChildRating filtered by the visible column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildRating[]|ObjectCollection findByArticleId(int $article_id) Return ChildRating objects filtered by the article_id column
 * @method     ChildRating[]|ObjectCollection findByPersonId(int $person_id) Return ChildRating objects filtered by the person_id column
 ...
 * @method     ChildRating[]|ObjectCollection findByVisible(string $visible) Return ChildRating objects filtered by the visible column
    ...
    public function filterByArticleId($articleId = null, $comparison = null)
    {
        if (is_array($articleId)) {
            ...
            if (isset($articleId['min'])) {
                $this->addUsingAlias(RatingTableMap::COL_ARTICLE_ID, $articleId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($articleId['max'])) {
                $this->addUsingAlias(RatingTableMap::COL_ARTICLE_ID, $articleId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByPersonId($personId = null, $comparison = null)
    {
        if (is_array($personId)) {
            ...
            if (isset($personId['min'])) {
                $this->addUsingAlias(RatingTableMap::COL_PERSON_ID, $personId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($personId['max'])) {
                $this->addUsingAlias(RatingTableMap::COL_PERSON_ID, $personId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
